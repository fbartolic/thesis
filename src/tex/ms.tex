...
\begin{figure}[t]
    \begin{centering}
        ...
        \script{mag_uniform_accuracy.py}
    \end{centering}
\end{figure}
...
\begin{figure}[t]
    \begin{centering}
        ...
        \script{mag_limbdark_accuracy.py}
    \end{centering}
\end{figure}
...
\begin{figure}[t]
    \begin{centering}
        ...
        \script{extended_source_test.py}
    \end{centering}
\end{figure}
...
\begin{figure}[t]
    \begin{centering}
        ...
        \script{lightcurve_gradients.py}
    \end{centering}
\end{figure}
...
%Single lens events are also about an order of magnitude more common than multiple lens 
%events and there exists a wealth of data from past surveys containing thousands of 
%single lens light curve that has not been fully utilized 
%\citep[see][for instance]{arXiv:2009.07927}.
...
\begin{figure}[!t]
    \begin{centering}
        ...
        \script{single_lens_fit_plots.py}
    \end{centering}
\end{figure}
...
\begin{figure}[t]
    \begin{centering}
        ...
        \script{single_lens_laplace_comparison.py}
    \end{centering}
\end{figure}
