...
#    theta_eg_dense = np.linspace(theta_eg[0], theta_eg[-1], 200)
    ...
    ax_map_in.set_rasterization_zorder(0)
    map.show(
    ...
    ax_map_eg.set_rasterization_zorder(0)
    ...
    if gp:
        fig.savefig(paths.figures/f"irtf_{year}.pdf", bbox_inches="tight", dpi=200)
    else:
        fig.savefig(
            paths.figures/f"irtf_{year}_no_GP.pdf",
            bbox_inches="tight",
            dpi=200,
        )
...
with open(paths.data/"output/mapping_io/irtf_processed/lc_1998-08-27.pkl", "rb") as handle:
    lc_in = pkl.load(handle)

with open(paths.data/"output/mapping_io/irtf_processed/lc_1998-11-29.pkl", "rb") as handle:
...
with open(paths.data/"output/mapping_io/irtf_1998_samples_no_GP.pkl", "rb") as handle:
...
with open(paths.data/"output/mapping_io/irtf_processed/lc_2017-03-31.pkl", "rb") as handle:
    lc_in = pkl.load(handle)

with open(paths.data/"output/mapping_io/irtf_processed/lc_2017-05-11.pkl", "rb") as handle:
    lc_eg = pkl.load(handle)

with open(paths.data/"output/mapping_io/irtf_2017_samples.pkl", "rb") as handle:
    samples = pkl.load(handle)

with open(paths.data/"output/mapping_io/irtf_2017_samples_no_GP.pkl", "rb") as handle:
    samples2 = pkl.load(handle)
