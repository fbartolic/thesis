...
def plot(
    ...
    ax_true_map.set_rasterization_zorder(0)
    ax_inf_map.set_rasterization_zorder(0)
...
plot(
    ...
    -0.1,
    1.1,
    paths.figures/"ingress_egress_sim_snr_50.pdf",
)
...
plot(
    ...
    -0.25,
    1.25,
    paths.figures/"ingress_egress_sim_snr_10.pdf",
)
